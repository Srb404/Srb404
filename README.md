...
IT engineer (B.Sc. in multimedia and internet technologies), currently doing a Master's in IT with a specialization in Data Science.
I build small, focused tools, mostly for the terminal and my own Linux setup (Arch + Hyprland), and I enjoy low-level code as much as backend and web work.
Open to my first full-time role as a developer.

**Languages:** Java · Python · JavaScript / TypeScript · C · C++ · Lua · Bash · x86-64 Assembly  
...
- IT work at a local government office: Bash scripts automating backups and server file cleanup, SQL views and reports for the office's departments, Python analysis and visualizations of municipal registry data for management, and log monitoring scripts that detect and report anomalies.
